        ...
        <div className="container flex flex-wrap mx-auto lg:text-left">
          <div className="w-full lg:w-1/3">
            <h2 className="mb-4 text-2xl font-bold">
              Đấu giá bất động sản FPT
            </h2>
            <p>
              Chúng tôi là điểm đến lý tưởng cho những người đang tìm kiếm cơ
              hội đầu tư hoặc mua bán bất động sản. Với một nền tảng đầy đủ các
              tính năng cực kì tiện ích, chúng tôi cung cấp một trải nghiệm đấu
              giá trực tuyến thuận lợi và an toàn.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/3 lg:text-left">
            ...
            <div className="flex space-x-4">
              <Link
                to="https://www.facebook.com/quangphu.le.528"
