...
<div>
            <div className="relative p-10 border rounded-md shadow-lg bg-slate-800 border-slate-400 backdrop-filter backdrop-blur-sm bg-opacity-30">
                <h1 className="mb-6 font-bold text-center text-white text-4x1">Sign Up</h1>
                <form action="">
                    ...
                    <div className="text-center">
                        <span className="flex justify-center m-4">Already Create an Account ?<Link className="ml-4 text-blue-500" to='/Login'>Login</Link></span>
                    </div>
                </form>
            </div>
