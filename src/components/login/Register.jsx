...
const Register = () => {
  ...
  return (
    <div className="flex h-screen">
      <div className="flex-shrink-0 w-1/2">
        <img
          src="đường_dẫn_đến_hình_ảnh_của_bạn.jpg"
          alt="Your Image"
      ...
      <div className="flex items-center justify-center flex-1 flex-shrink-0 w-full p-4 bg-blue-300 border-l border-gray-300">
        ...
        <h2 className="text-2xl font-bold text-gray-500">Please create an account if you don't have one </h2>
  ...
  <span>Already have an account? <Link to="/login" className="text-black hover:text-red-700">Login here</Link></span>
</div>
