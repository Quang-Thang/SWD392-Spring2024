...
const UserInformation = () => {
  ...
  <div className="flex justify-between mb-8">
    <h1 className="text-3xl font-semibold text-primary">User Information</h1>
    {!isEditing && (
      <button
        ...
        <div>
          <div className="grid grid-cols-3 mt-8 gap-x-4">
            <Field
              ...
              readOnly={!isEditing}
            />
            <ErrorMessage name="familyName" component="div" className="text-red-500" />
            <Field
              type="text"
              name="middleName"
          ...
          <div className="grid grid-cols-3 mt-8 gap-x-4">
            <label className="relative">
              <Datepicker
                ...
                className="px-4 py-3 border border-gray-300 rounded-md outline-none focus:border-primary"
                icon={<FaCalendarAlt className="absolute text-gray-400 transform -translate-y-1/2 right-3 top-1/2" />}
                readOnly={!isEditing}
              />
            </label>
